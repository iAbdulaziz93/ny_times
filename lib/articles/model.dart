class MostPopularArticlesModel {
  String? status;
  String? copyright;
  int? numResults;
  List<MostPopularArticles>? results;

  MostPopularArticlesModel({
    this.status,
    this.copyright,
    this.numResults,
    this.results,
  ...
  MostPopularArticlesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    copyright = json['copyright'];
    numResults = json['num_results'];
    if (json['results'] != null) {
      results = <MostPopularArticles>[];
      json['results'].forEach((v) {
        results!.add(MostPopularArticles.fromJson(v));
      });
    }
  }
